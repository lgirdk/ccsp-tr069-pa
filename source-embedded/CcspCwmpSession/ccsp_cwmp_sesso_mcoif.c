    ...
    )
{
    ...
    */
    ...
    /* FirmwareToDownload */
    SlapAllocVariable(pSlapVar2);
    if ( !pSlapVar2 ) goto EXIT1;

    pSlapVar2->Syntax = SLAP_VAR_SYNTAX_string;
    pSlapVar2->Variant.varString = strdup(p + 1);
    ...
    pParamValueArray[1].Value           = pSlapVar2;
